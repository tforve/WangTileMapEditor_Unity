...
public class Grid : MonoBehaviour
{
    ...
    private int MAX_X, MAX_Y;                               // Max Tiles in height and width depending on screensize and tileSize
    ...
    void GenerateGrid()
    {
        ...
        MAX_X = (int)(rt.rect.width  / tileSize);       //Screen.width / tileSize;
        MAX_Y = (int)(rt.rect.height / tileSize);        //Screen.height / tileSize;
